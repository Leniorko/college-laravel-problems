...
<div class="container text-center">
    ...
    <form class="form-signin col-md-4 col-md-offset-4" action="/register" method="POST">
      @csrf
      @method("POST")
      ...
      <div class="checkbox">
        <label>
          <input type="checkbox" value="remember-me" name="personal_data_confirmation" required> Согласие на обработку персональных данных
        </label>
      </div>
